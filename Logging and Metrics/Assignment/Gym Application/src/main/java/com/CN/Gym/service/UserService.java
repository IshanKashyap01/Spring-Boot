...
public class UserService {
    ...
    public UserService(CompositeMeterRegistry registry)
    {
        userCounter = registry.counter("count.of.registration");
    }
    ...
    public void createUser(UserRequest userRequest) {
        ...
        String message = "Saving user " + user.getEmail() + " with role " + role.getRoleName();
        logger.info(message);

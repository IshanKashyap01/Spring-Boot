...
{    
    ...
    public String getAttendent(@PathVariable String attendentId, ModelMap map)
    {
        //Write your Logic here
        map.addAttribute("attendentName", "TEST 123");
        map.addAttribute("speciality", "Engine,Body,Shop");
        return "attendent";
    }
}

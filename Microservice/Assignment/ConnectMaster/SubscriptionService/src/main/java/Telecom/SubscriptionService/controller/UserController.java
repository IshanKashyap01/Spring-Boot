...
public class UserController {
    ...
    public List<Object> getUserTickets(@PathVariable Long userId) {
        return userService.getAllUserTickets(userId);
    }

    public List<Object> getUserTicketsFallback(@PathVariable Long userId) {

...
public class Controller {
	...
	@PostMapping("/ticket")
	public void addTicket(@Valid @RequestBody Ticket ticket, BindingResult validator) 
	{
		if(validator.hasErrors())
		{
			throw new TicketBodyInvalidException("Ticket data invalid");
		}
	...
	//add annotation for handling error if the data is invalid using the BindingResult class.
	@PutMapping("/ticket")
	public void updateTicket(@Valid @RequestBody Ticket ticket, BindingResult validator)
	{
		if(validator.hasErrors())
		{
			throw new TicketBodyInvalidException("Ticket data invalid");
